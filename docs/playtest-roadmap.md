...
- Add a versioned report envelope with build information and current version-4 game replays. Continue accepting standalone version-4 replays. Older simulation versions remain incompatible.
